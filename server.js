...
Rules:
- Return ONLY the single word or very short phrase (2–3 words max) that the player must draw. No punctuation, no explanation, no extra text.
...
- Never repeat a boring or overused word like "tree", "house", "dog", "cat", "flower", "car", "sun" unless it has been a very long time.
